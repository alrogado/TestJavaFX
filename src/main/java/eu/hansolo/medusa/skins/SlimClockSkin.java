...
public class SlimClockSkin extends ClockSkinBase {
    ...
    @Override protected void initGraphics() {
        ...
        secondBackgroundCircle.setStrokeWidth(PREFERRED_WIDTH * 0.028);
        ...
        secondArc.setStrokeWidth(PREFERRED_WIDTH * 0.028);
    ...
    @Override public void updateTime(final ZonedDateTime TIME) {
        if (dateText.isVisible()) {
            ...
            dateText.relocate((size - dateText.getLayoutBounds().getWidth()) * 0.52, size * 0.12180451);
    ...
    @Override protected void resize() {
        ...
        if (size > 0) {
            ...
            dateText.setFont(Fonts.robotoBold(size * 0.2));
            dateNumbers.setFont(Fonts.robotoBold(size * 0.2));

            hour.setFont(Fonts.robotoBold(size * 0.328));
            minute.setFont(Fonts.robotoBold(size * 0.328));
        }
    }
