...
import static org.testjavafx.util.GuiColors.*;

@ViewController(value = "/org/testjavafx/fxml/ui/main_content.fxml")
public class MainContentController {
    ...
    private void configureButtonsPane() {
        customButton.setGraphic(IkonUtils.customizeIkon(Fontelico.EMO_BEER));
        centerButton.setTextFill(FRG_FILL);
        centerButton.setGraphic(IkonUtils.customizeIkon(Fontelico.EMO_SHOOT));
        rightButton.setGraphic(IkonUtils.customizeIkon(Fontelico.EMO_COFFEE));
        leftButton.setGraphic(IkonUtils.customizeIkon(Typicons.CHEVRON_LEFT));

        leftButton.setGraphic(IkonUtils.customizeIkon(Fontelico.EMO_DEVIL));
        topButton.setGraphic(IkonUtils.customizeIkon(Typicons.BOOK));
