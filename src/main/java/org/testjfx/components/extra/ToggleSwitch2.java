 ...
 */
public class ToggleSwitch2 extends Labeled {
     ...
     */
    public ToggleSwitch2(String turnOnText, String turnOffText) {
...
//                    accSendNotification(Attribute.SELECTED);
    ...
    @Override protected Skin<?> createDefaultSkin() {
        return new ToggleSwitchSkin2(this);
    }
