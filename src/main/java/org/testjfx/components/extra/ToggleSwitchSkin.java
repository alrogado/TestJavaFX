 ...
 */
public class ToggleSwitchSkin extends SkinBase<ToggleSwitch2>{
    StackPane thumb;
    StackPane thumbArea;
    LabeledText label;
     ...
     */
    protected ToggleSwitchSkin(ToggleSwitch2 control) {
        super(control);
    ...
    protected void layoutChildren(double contentX, double contentY, double contentWidth, double contentHeight) {
        ...
        {
            thumb.setLayoutX(thumbArea.getLayoutX() + thumbAreaWidth - thumbWidth-30);
            thumb.setLayoutY(thumbAreaY + (thumbAreaHeight - thumbHeight) / 2);
        }
    }
