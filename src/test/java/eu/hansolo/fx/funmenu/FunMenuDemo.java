...
public class FunMenuDemo extends Application {
    ...
    @Override public void start(Stage stage) {
        ...
        scene.getStylesheets().add(FunMenuDemo.class.getResource("/eu/hansolo/fx/funmenu/styles.css").toExternalForm());
        scene.getStylesheets().add(FunMenuDemo.class.getResource("/eu/hansolo/fx/funmenu/funmenu.css").toExternalForm());
